...
A local-first web prototype for programmable sumo robot battles. The current vertical slice includes a playable best-of-three match, three control modes, campaign progression, a cosmetic market and inventory, leaderboards, a starter scripting lab, and representative analytics views.
