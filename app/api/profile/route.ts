...
import { getOnlineProfile, importOnlineProfile, purchaseMarketItem, saveOnlineProfile } from "@/lib/profile/server";
...
export async function POST(request: Request) {
  ...
  const body = await request.json() as { action?: string; profile?: unknown; itemId?: unknown };
