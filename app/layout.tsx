...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = "Sumobot — Learn, Build, Battle";
  ...
  return {
    ...
    description,
    openGraph: { title, description, type: "website", url: origin, images: [{ url: `${origin}/og.png`, width: 1731, height: 909, alt: "Two programmable Sumobot robots colliding in the arena" }] },
